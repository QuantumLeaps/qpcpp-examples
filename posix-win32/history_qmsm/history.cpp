...
constexpr QP::QMState ToastOven::doorClosed_s = {
...
QM_ACTION_DEF(ToastOven, doorClosed_x) {
    ...
    hist_doorClosed = childStateObj(&doorClosed_s);
...
constexpr QP::QMState ToastOven::heating_s = {
...
constexpr QP::QMState ToastOven::toasting_s = {
...
constexpr QP::QMState ToastOven::baking_s = {
    &ToastOven::heating_s, // superstate
    &ToastOven::baking,
    &ToastOven::baking_e,
    Q_ACTION_NULL, // no exit action
...
//${SMs::ToastOven::SM::doorClosed::off} .....................................
constexpr QP::QMState ToastOven::off_s = {
    &ToastOven::doorClosed_s, // superstate
    &ToastOven::off,
    &ToastOven::off_e,
    Q_ACTION_NULL, // no exit action
...
constexpr QP::QMState ToastOven::doorOpen_s = {
    QM_STATE_NULL, // superstate (top)
    &ToastOven::doorOpen,
...
QM_STATE_DEF(ToastOven, doorOpen) {
    ...
    switch (e->sig) {
        ...
        case OFF_SIG: {
            ...
            status_ = qm_tran_hist(hist_heating, &tatbl_);
            break;
        }
        default: {
            status_ = Q_RET_SUPER;
...
constexpr QP::QMState ToastOven::final_s = {
    QM_STATE_NULL, // superstate (top)
    &ToastOven::final,
    &ToastOven::final_e,
    Q_ACTION_NULL, // no exit action
