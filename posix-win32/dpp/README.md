...
https://www.state-machine.com/qpcpp/tut_dpp.html
...
- the `dpp_console.qm` model file, from which all other
  ...
  - `app.hpp`    - the generated interface for the DPP application
  - `bsp.hpp`    - the generated interface for the Board Support Package
  - `bsp.cpp`    - the generated code for the Board Support Package
  - `main.cpp`   - the generated code for the main function
  - `philo.cpp`  - the generated code for the Philo Active Object
  - `table.cpp`  - the generated code for the Table Active Object
