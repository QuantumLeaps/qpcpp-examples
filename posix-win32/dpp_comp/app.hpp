...
//$declare${Comp::SM_Philo} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace APP {

//${Comp::SM_Philo} ..........................................................
extern std::array<QP::QAsm * const, N_PHILO> SM_Philo;

} // namespace APP
//$enddecl${Comp::SM_Philo} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
