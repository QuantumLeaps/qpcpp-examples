...
Q_STATE_DEF(Alarm, off) {
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
            ...
            BSP::showTime24H("*** Alarm OFF ", m_alarm_time, 100U);
        ...
        case ALARM_ON_SIG: {
            ...
            //${Components::Alarm::SM::off::ALARM_ON::[else]}
                ...
                m_alarm_time = 0U;
                BSP::showTime24H("*** Alarm reset", m_alarm_time, 100U);
                status_ = Q_RET_HANDLED;
            }
            break;
        }
...
Q_STATE_DEF(Alarm, on) {
    ...
    switch (e->sig) {
        //${Components::Alarm::SM::on}
        case Q_ENTRY_SIG: {
            BSP::showTime24H("*** Alarm ON ",  m_alarm_time, 60U);
            status_ = Q_RET_HANDLED;
            break;
        }
        ...
        case ALARM_SET_SIG: {
            BSP::showMsg("*** Cannot set Alarm when it is ON");
            status_ = Q_RET_HANDLED;
            break;
        }
        ...
        case TIME_SIG: {
            ...
            if (Q_EVT_CAST(TimeEvt)->current_time == m_alarm_time) {
                ...
                APP_alarmClock->POST(QP::QF::q_new<QP::QEvt>(ALARM_SIG), this);
                status_ = Q_RET_HANDLED;
            }
            else {
