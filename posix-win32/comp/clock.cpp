...
//${App::APP_alarmClock} .....................................................
QP::QActive * const APP_alarmClock = &AlarmClock::inst;
//$enddef${App} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//$define${Components::AlarmClock} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv

//${Components::AlarmClock} ..................................................
AlarmClock AlarmClock::inst;
...
Q_STATE_DEF(AlarmClock, timekeeping) {
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
            ...
            m_timeEvt.armX(BSP::TICKS_PER_SEC, BSP::TICKS_PER_SEC);
...
Q_STATE_DEF(AlarmClock, mode24h) {
    ...
    switch (e->sig) {
        ...
        case TICK_SIG: {
            ...
            BSP::showTime24H("", m_current_time, 60U);
...
Q_STATE_DEF(AlarmClock, mode12h) {
    ...
    switch (e->sig) {
        ...
        case TICK_SIG: {
            ...
            BSP::showTime12H("", m_current_time, 60U);
