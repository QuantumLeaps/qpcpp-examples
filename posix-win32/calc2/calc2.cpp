...
Q_STATE_DEF(Calc, zero) {
    ...
    switch (e->sig) {
        //${SMs::Calc::SM::on::operand::zero}
        case Q_ENTRY_SIG: {
            BSP::message("zero-ENTRY;");
            status_ = Q_RET_HANDLED;
            break;
        }
        //${SMs::Calc::SM::on::operand::zero}
        case Q_EXIT_SIG: {
            BSP::message("zero-EXIT;");
            status_ = Q_RET_HANDLED;
            break;
        }
...
Q_STATE_DEF(Calc, intg) {
    ...
    switch (e->sig) {
        //${SMs::Calc::SM::on::operand::intg}
        case Q_ENTRY_SIG: {
            BSP::message("intg-ENTRY;");
            status_ = Q_RET_HANDLED;
            break;
        }
        //${SMs::Calc::SM::on::operand::intg}
        case Q_EXIT_SIG: {
            BSP::message("intg-EXIT;");
            status_ = Q_RET_HANDLED;
            break;
        }
...
Q_STATE_DEF(Calc, frac) {
    ...
    switch (e->sig) {
        //${SMs::Calc::SM::on::operand::frac}
        case Q_ENTRY_SIG: {
            BSP::message("frac-ENTRY;");
            status_ = Q_RET_HANDLED;
            break;
        }
        //${SMs::Calc::SM::on::operand::frac}
        case Q_EXIT_SIG: {
            BSP::message("frac-EXIT;");
            status_ = Q_RET_HANDLED;
            break;
        }
