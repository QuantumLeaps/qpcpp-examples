...
private:
    ...
    std::array<QP::QAsm *, GAME_MINES_MAX> m_mines;
    std::array<QP::QAsm *, GAME_MINES_MAX> m_mine1_pool;
    std::array<QP::QAsm *, GAME_MINES_MAX> m_mine2_pool;
...
#endif
//$endskip${QP_VERSION} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//$define${App::QTicker_inst0} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace APP {

//${App::QTicker_inst0} ......................................................
QP::QTicker QTicker_inst0 = QP::QTicker(0U);

} // namespace APP
//$enddef${App::QTicker_inst0} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//$define${App::AO_Tunnel} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace APP {
