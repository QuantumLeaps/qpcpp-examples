...
static void playerTrigger();
    ...
    static QP::QSpyId const l_player     { 0U };
#endif
...
void init(void const * const arg) {
    ...
    QS_OBJ_DICTIONARY(&APP::QTicker_inst0);
    ...
    QS_GLB_FILTER(QP::QS_GRP_SM); // state machine records
    QS_GLB_FILTER(QP::QS_GRP_AO); // active object records
    QS_GLB_FILTER(QP::QS_GRP_UA); // all user records
...
//............................................................................
bool isThrottle() { // is the throttle button depressed?
...
//............................................................................
bool doBitmapsOverlap(std::uint8_t bmp_id1, std::uint8_t x1, std::uint8_t y1,
...
//............................................................................
static void paintBitsClear(std::uint8_t x, std::uint8_t y,
    std::uint8_t const *bits, std::uint8_t h)
{
    uint32_t *fb = &l_fb[y][x >> 5];
    uint32_t shift = (x & 0x1FU);
...
//............................................................................
static void playerTrigger() {
    static QP::QEvt const fireEvt(APP::PLAYER_TRIGGER_SIG);
#ifdef Q_SPY
...
void QF::onClockTick() {
    ...
    APP::QTicker_inst0.TRIG(&l_clock_tick); // trigger ticker AO
    ...
    WPARAM wParam, LPARAM lParam)
{
    switch (iMsg) {
        ...
        case WM_INITDIALOG: {
            ...
            if (CreateThread(NULL, 0, &appThread, NULL, 0, NULL) == 0) {
                Q_ERROR();
            }
            return 0;
        }
