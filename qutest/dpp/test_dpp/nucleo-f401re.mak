##############################################################################
# Makefile for QUTEST-QP/C on NUCLEO-F401RE, GNU-ARM
#
...
# make -f nucleo-f401re.mak USB=g: # make, upload to USB drive, run the tests
# make -f nucleo-f401re.mak USB=g: TESTS=philo*.py  # make and run the selected tests
# make -f nucleo-f401re.mak norun   # only make but not run the tests
# make -f nucleo-f401re.mak clean   # cleanup the build
# make -f nucleo-f401re.mak debug   # only run tests in DEBUG mode
#
# NOTE:
