...
expect("@timestamp AO-Post  Sdr=Philo::inst[2],Obj=Table_dummy,Evt<Sig=HUNGRY_SIG,Pool=1,Ref=1>*")
...
expect("           TE0-ADis Obj=Philo::inst[2].m_timeEvt,AO=Philo::inst[2]")
expect("@timestamp TE0-Post Obj=Philo::inst[2].m_timeEvt,Sig=TIMEOUT_SIG,AO=Philo::inst[2]")
expect("@timestamp AO-Post  Sdr=QS_RX,Obj=Philo::inst[2],Evt<Sig=TIMEOUT_SIG,Pool=0,*")
expect("@timestamp AO-GetL  Obj=Philo::inst[2],Evt<Sig=TIMEOUT_SIG,Pool=0,*")
...
expect("@timestamp MP-Get   Obj=EvtPool1,*")
expect("@timestamp QF-New   Sig=HUNGRY_SIG,*")
expect("@timestamp AO-Post  Sdr=Philo::inst[2],Obj=Table_dummy,Evt<Sig=HUNGRY_SIG,Pool=1,*")
expect("@timestamp QUTEST_ON_POST HUNGRY_SIG,Obj=Table_dummy 2")
expect("@timestamp QF-gc    Evt<Sig=HUNGRY_SIG,*")
